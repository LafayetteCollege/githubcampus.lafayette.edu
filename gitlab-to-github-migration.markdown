...
<ol>
    ...
    <li>Through Command Line, enter <code>git clone --bare [url]</code> to make a bare clone, replacing &lt;url&gt; with the SSH URL from GitLab.</li>
...
<ol>
    ...
    <li>On GitHub, navigate to your repository and click the <strong>&lt;&gt;</strong> code button, then copy the URL to your new repository.</li>
